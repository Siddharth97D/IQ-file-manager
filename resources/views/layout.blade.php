...
<head>
    ...
    <!-- Dark Mode & Shortcuts -->
    <link rel="stylesheet" href="{{ asset('vendor/file-manager/css/dark-mode.css') }}">
</head>
<body class="bg-gray-100 font-sans antialiased" x-data="{ 
    ...
    <div class="flex h-screen overflow-hidden bg-gray-50">
        ...
        <div class="w-72 sidebar flex flex-col shadow-xl z-20">
            ...
            <nav class="flex-1 px-4 space-y-2 overflow-y-auto">
                ...
                <!-- Theme Toggle -->
                <button id="fm-theme-toggle" class="w-full text-left sidebar-link flex items-center px-4 py-3 cursor-pointer">
                    <svg class="w-5 h-5 mr-3 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"></path></svg>
    ...
    <script src="{{ asset('vendor/file-manager/js/shortcuts.js') }}"></script>
